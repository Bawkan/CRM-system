...
SECRET_KEY = "django-insecure-1y&du@h+z@p)7hios^egct0i2#y*_^rl$u2-!79k*ve^&jpds_"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "crm.context_processors.contents"
            ],
        },
    },
]
